...
public class AppTests extends TestBase {
    ...
    void titleTest() {
        step("Open url 'https://codepen.io/'", () ->
            open("https://codepen.io/"));

        step("Page title should have text 'Attention Required! | Cloudflare'", () -> {
            String expectedTitle = "Attention Required! | Cloudflare";
